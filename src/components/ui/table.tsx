...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn("[&_tr]:border-b [&_tr]:border-border bg-muted/30 dark:bg-muted/20", className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      "border-t border-border bg-muted/50 dark:bg-muted/20 font-medium [&>tr]:last:border-b-0",
      className
    )}
    {...props}
  />

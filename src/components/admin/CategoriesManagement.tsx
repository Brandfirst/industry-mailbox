...
const DialogFooter = ({
  className,
  ...props
}) => (<div className={cn("sm:flex justify-end gap-2", className)} {...props} />);
DialogFooter.displayName = "DialogFooter";
const Dialog = React.forwardRef(({
  className,
  children,
  ...props
}, ref) => /*#__PURE__*/React.createElement(DialogPrimitive.Portal, null, /*#__PURE__*/React.createElement(DialogPrimitive.Overlay, {
  className: "fixed inset-0 z-50 bg-black/80 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0"
}), /*#__PURE__*/React.createElement(DialogPrimitive.Content, {
  ref: ref,

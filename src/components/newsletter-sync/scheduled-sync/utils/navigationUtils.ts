...
export const createNewsletterNavigationHandler = (
  ...
  return async (e: React.MouseEvent) => {
    ...
    if (newsletterId) {
      ...
      // Direct navigation to the newsletter detail page - removing the "admin/" prefix
      ...
      try {
        ...
        if (newsletters && newsletters.length > 0) {
          ...
          // Direct navigation to the found newsletter - removing the "admin/" prefix
      ...
      // Navigate to newsletter page with sender filter - removing "admin/" prefix

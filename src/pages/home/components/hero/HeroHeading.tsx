...
const HeroHeading = () => {
  ...
  return <div className="animate-slide-down max-w-5xl mx-auto">
      <h1 className="text-4xl md:text-5xl lg:text-6xl font-ebgaramond tracking-tight mb-6">
        <span className="block text-white mb-2 py-[14px]">Norges største database</span>
      ...
      <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto mb-8">
        Utforsk mer enn 
        <DynamicCounter startValue={70350} incrementAmount={7} intervalMs={1000} prefix=" " suffix=" " />
         nyhetsbrev fra 
        <DynamicCounter startValue={1750} incrementAmount={2} intervalMs={1000} prefix=" " suffix=" " />
        varemerker. 

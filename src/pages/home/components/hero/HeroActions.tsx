...
const HeroActions = () => {
  return (
    <div className="flex flex-wrap justify-center gap-4 mt-10">
      <Link to="/search">
        <Button size="lg" className="announcement-glow-container relative overflow-hidden">
      ...
      <Link to="/auth?mode=signup">
        <Button size="lg" variant="outline" className="announcement-glow-container relative overflow-hidden">
          <div className="absolute inset-0 announcement-glow-effect"></div>

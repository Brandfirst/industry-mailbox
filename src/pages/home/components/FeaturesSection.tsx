...
import { Database, BarChart, Star, Award, Brain, LineChart, Bot, Search, FileText, MessageSquare } from "lucide-react";
    ...
    <section className="py-20 bg-black">
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">Avanserte verktøy for nyhetsbrev-analyse</h2>
        ...
        <div className="bg-[#0A0A0A] rounded-xl border border-[#3a6ffb]/20 p-8 mb-16">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <h3 className="text-2xl font-bold mb-4 text-white">AI scanner nyhetsbrev for konkurransefortrinn</h3>
